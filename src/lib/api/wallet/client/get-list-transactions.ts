...
export const getClientTransactionsList = (params: PaginationParams): Promise<Pagination<Transaction>> =>
  get<Pagination<Transaction>>(`${config.BACKEND_URL}/api/v1/web/client/transactions/`, keysToSnake(params))
