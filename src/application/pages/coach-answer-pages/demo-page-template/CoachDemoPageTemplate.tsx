...
import { FeatureItem } from "@/application/pages/coach-answer-pages/demo-page-template/FeatureItem"
...
export const CoachDemoPageTemplate = (props: DemoPageTemplateTypes) => (
  <Container>
    ...
    <Content>
      ...
      <ImageContent>{props.rightImage()}</ImageContent>
    </Content>
  </Container>
)
