...
import { SelectInputCard } from "@/oldcomponents/select-input/SelectInputCard"
    ...
    <StyledDialog value={visibility} onChange={() => _toggleCreditCardsModal(false)}>
      <Container>
        ...
        {value.id === "other" && (
          <>
            <Description>
              Вы будете перенаправлены на страницу платежного провайдера для добавления и привязки карты (будет списан и возвращен 1 рубль).
            </Description>
