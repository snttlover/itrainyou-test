    ...
    <Container>
      ...
      {legalForm.coach?.legalForm === "IP_OTHER_TAXES" ?
        <InterviewQuestions>
          ...
          <Question>
            <div>
              На e-mail, который Вы использовали при регистрации на https://itrainyou.ru/,
              Вам будет направлено приглашение присоединиться к ЮКассе, пройдите
              по ссылке в этом приглашении (кнопка “Подключить Кассу”)
              и зарегистрируйтесь в ЮКассе
              <br/>
              Если Вы не получили приглашение, обязательно проверьте папку "Спам" и правильность адреса,
              который вы указали при регистрации,
              в <a href="/coach/settings">настройках</a>
            </div>
          </Question>
          <Question>
