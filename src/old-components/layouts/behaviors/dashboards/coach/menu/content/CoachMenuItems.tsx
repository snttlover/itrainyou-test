...
import { DashboardMenuItem } from "@/old-components/layouts/behaviors/dashboards/common/menu/content/DashboardMenuItem"
...
export const CoachMenuItems = () => {
  ...
  return (
    <ItemsWrapper>
      ...
      <DashboardMenuItem link={routeNames.coachSupport()} icon='help' badgeNumber={supportChatsCount}>
        Поддержка
      </DashboardMenuItem>
      <Delimiter />
