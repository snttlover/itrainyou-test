...
import { togglePermissionGrantedModal, $permissionGrantedModalVisibility, $modalInfo } from "@/oldcomponents/layouts/behaviors/dashboards/call/create-session-call.model"
